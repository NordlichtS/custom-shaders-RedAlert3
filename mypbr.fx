...
//about sun and eye, also nrm backface fix
    ...
    float3 ground_color = helper_mapcolor_chooser (GROUND_index, i.color.xyz) * ambient_multiply;
    float3 sky_color    = helper_mapcolor_chooser (SKY_index,    i.color.xyz) * ambient_multiply;
